        ...
        <main className="flex flex-1 flex-col items-center justify-center gap-2">
            <div className="flex gap-4">
                ...
                {fruitsList.map((fruit, index) => (
                    FruitCard({ index, fruitName: fruit.nom, fruitImage: fruit.image })
                ))}
...
const FruitCard = (props: FruitProps) => {
    ...
    return <Card key={index} className="w-[300px] overflow-hidden transition-all duration-200 hover:scale-105 hover:shadow-md hover:shadow-gray-300">
        ...
        <CardContent className="line-clamp-3">
            ...
            sint dolore tempore accusantium, atque, alias minima dolorum
            adipisci magni aliquid.
        </CardContent>
